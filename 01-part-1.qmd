...
In this tutorial we will be using data from the [PUMS 2016-2020 ACS 5 year dataset](https://www.census.gov/programs-surveys/acs/microdata/access.2020.html#list-tab-735824205). We will be accessing these PUMS files through the File Transfer Protocol (FTP). 
