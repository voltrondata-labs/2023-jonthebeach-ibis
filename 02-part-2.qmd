...
using the five-year data from 2020, found
[here](https://www2.census.gov/programs-surveys/acs/data/pums/2020/).

We may have already downloaded the data for you, check with your instructor! If
this is the case skip to [this section](#examining-the-data).

### Downloading the Data

You can download the data in CSV format using this FTP
URL: ftp://ftp.census.gov/programs-surveys/acs/data/pums/2020/5-Year/.
